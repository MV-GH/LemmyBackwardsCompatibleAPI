...
enum class CommunityVisibility(override val minimumVersion: Version = V0_19_4, override val maximumVersion: Version? = null) :
    ...
    @SerialName("local_only") LocalOnly(V0_19_4, V1_0_0),
    @SerialName("unlisted") Unlisted(V1_0_0),
    @SerialName("local_only_public") LocalOnlyPublic(V1_0_0),
    @SerialName("local_only_private") LocalOnlyPrivate(V1_0_0),
    @SerialName("private") Private(V1_0_0),
}
