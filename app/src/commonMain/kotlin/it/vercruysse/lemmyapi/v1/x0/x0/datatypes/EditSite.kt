...
internal data class EditSite(
    ...
    val post_upvotes: String? /* "All" | "Local" | "Disable" */ = null,
    val post_downvotes: String? /* "All" | "Local" | "Disable" */ = null,
    val comment_upvotes: String? /* "All" | "Local" | "Disable" */ = null,
    val comment_downvotes: String? /* "All" | "Local" | "Disable" */ = null,
