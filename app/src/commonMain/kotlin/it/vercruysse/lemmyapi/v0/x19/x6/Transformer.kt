...
internal class Transformer : MapperGenerator {
    ...
    override fun toUni(d: X6DatatypesBlockCommunityResponse): LemmyapiDatatypesCommunityResponse =
    ...
    override fun toUni(d: X6DatatypesResolveObjectResponse): LemmyapiDatatypesSearchResponse =
