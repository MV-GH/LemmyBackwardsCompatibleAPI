...
internal interface LemmyApiRouter {
     ...
     */
    suspend fun resetPassword(form: PasswordReset): Result<Unit>
     ...
     */
    suspend fun changePasswordAfterReset(form: PasswordChangeAfterReset): Result<Unit>
     ...
     * @POST("site/block")
     */
    suspend fun blockInstance(form: BlockInstance): Result<Unit>
     ...
     */
    suspend fun listLogins(): Result<List<LoginToken>>
     ...
     * @GET("post/like/list")
     */
    suspend fun listPostLikes(form: ListPostLikes): Result<ListPostLikesResponse>
     ...
     */
    suspend fun listCommentLikes(form: ListCommentLikes): Result<ListCommentLikesResponse>
     ...
     */
    suspend fun listMedia(form: ListMedia): Result<ListMediaResponse>
     ...
     */
    suspend fun listAllMedia(form: ListMedia): Result<ListMediaResponse>
     ...
     * @POST("post/hide")
     */
    suspend fun hidePost(form: HidePost): Result<Unit>
