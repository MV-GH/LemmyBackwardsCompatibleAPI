...
internal class Transformer : MapperGenerator {
    ...
    override fun toUni(d: X11DatatypesBlockCommunityResponse): LemmyapiDatatypesCommunityResponse =
    ...
    override fun fromUni(d: LemmyapiDatatypesHidePosts): X11DatatypesHidePost = X11DatatypesHidePost(
        post_ids = d.post_ids,
        hide = d.hide,
    )
