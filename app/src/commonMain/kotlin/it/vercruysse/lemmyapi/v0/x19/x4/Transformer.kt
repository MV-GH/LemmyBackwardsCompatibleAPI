...
internal class Transformer : MapperGenerator {
    ...
    override fun toUni(d: X4DatatypesBanFromCommunityResponse): it.vercruysse.lemmyapi.datatypes.PersonResponse =
        it.vercruysse.lemmyapi.datatypes.PersonResponse(person_view = this.toUni(d = d.person_view))

    override fun toUni(d: X4DatatypesBanPersonResponse): it.vercruysse.lemmyapi.datatypes.PersonResponse =
        it.vercruysse.lemmyapi.datatypes.PersonResponse(person_view = this.toUni(d = d.person_view))

    override fun toUni(d: X4DatatypesBlockCommunityResponse): LemmyapiDatatypesCommunityResponse =
        LemmyapiDatatypesCommunityResponse(community_view = this.toUni(d = d.community_view), discussion_languages = emptyList())

    override fun toUni(d: X4DatatypesBlockPersonResponse): it.vercruysse.lemmyapi.datatypes.PersonResponse =
        it.vercruysse.lemmyapi.datatypes.PersonResponse(person_view = this.toUni(d = d.person_view))
    ...
    override fun toUni(d: X4DatatypesCommunityView): LemmyapiDatatypesCommunityView =
        LemmyapiDatatypesCommunityView(
            ...
            community_actions = CommunityActions(
                null,
                CommunityFollowerState.from(d.subscribed),
                if (d.blocked) "" else null,
                null,
                if (d.banned_from_community) "" else null,
                if (d.banned_from_community) "" else null,
            ),
        )
    ...
    override fun toUni(d: X4DatatypesPostReportView): LemmyapiDatatypesPostReportView =
        LemmyapiDatatypesPostReportView(
            ...
            post_actions = PostActions(toAt(d.read), null, d.counts.comments - d.unread_comments, toAt(d.saved), null, VoteAction.from(d.my_vote), toAt(d.hidden)),
    ...
    override fun toUni(d: X4DatatypesResolveObjectResponse): LemmyapiDatatypesSearchResponse =
    ...
    override fun fromUni(d: LemmyapiDatatypesHidePosts): X4DatatypesHidePost = X4DatatypesHidePost(
        post_ids = d.post_ids,
        hide = d.hide,
    )
