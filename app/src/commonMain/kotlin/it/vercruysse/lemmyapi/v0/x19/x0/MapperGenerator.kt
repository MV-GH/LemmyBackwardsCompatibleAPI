...
internal interface MapperGenerator {
    ...
    fun toUni(d: Community, counts: CommunityAggregates): it.vercruysse.lemmyapi.datatypes.Community
    ...
    fun toUni(d: ResolveObjectResponse): it.vercruysse.lemmyapi.datatypes.SearchResponse
    ...
    // Legacy specific list*Requests (still used internally)
