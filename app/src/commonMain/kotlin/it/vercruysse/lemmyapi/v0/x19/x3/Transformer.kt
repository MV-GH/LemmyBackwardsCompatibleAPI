...
internal class Transformer : MapperGenerator {
    ...
    override fun toUni(d: X3DatatypesCommunity, counts: X3DatatypesCommunityAggregates): LemmyapiDatatypesCommunity =
    ...
    override fun toUni(d: X3DatatypesLocalSite, counts: X3DatatypesSiteAggregates): LemmyapiDatatypesLocalSite =
    ...
    override fun toUni(d: X3DatatypesAddModToCommunityResponse): LemmyapiDatatypesAddModToCommunityResponse = LemmyapiDatatypesAddModToCommunityResponse(
    ...
    override fun toUni(d: X3DatatypesAdminPurgeCommunityView): LemmyapiDatatypesAdminPurgeCommunityView = LemmyapiDatatypesAdminPurgeCommunityView(
    ...
    override fun toUni(d: X3DatatypesBanFromCommunityResponse): LemmyapiDatatypesBanFromCommunityResponse = LemmyapiDatatypesBanFromCommunityResponse(
    ...
    override fun toUni(d: X3DatatypesComment, counts: X3DatatypesCommentAggregates): LemmyapiDatatypesComment = LemmyapiDatatypesComment(
        id = d.id,
    ...
    override fun toUni(d: X3DatatypesGenerateTotpSecretResponse): LemmyapiDatatypesGenerateTotpSecretResponse = LemmyapiDatatypesGenerateTotpSecretResponse(
    ...
    override fun toUni(d: X3DatatypesGetPersonDetailsResponse): LemmyapiDatatypesGetPersonDetailsResponse = LemmyapiDatatypesGetPersonDetailsResponse(
        person_view = this.toUni(d = d.person_view),
        site = d.site?.let { this.toUni(d = it) },
        comments = d.comments.map { this.toUni(d = it) },
    ...
    override fun toUni(d: X3DatatypesInstanceWithFederationState): LemmyapiDatatypesInstanceWithFederationState = LemmyapiDatatypesInstanceWithFederationState(
        id = d.id,
        domain = d.domain,
        published_at = d.published,
        updated_at = d.updated,
    ...
    override fun toUni(d: X3DatatypesListCommentLikesResponse): LemmyapiDatatypesListCommentLikesResponse = LemmyapiDatatypesListCommentLikesResponse(
        comment_likes = d.comment_likes.map { this.toUni(d = it) },
    )

    override fun toUni(d: X3DatatypesListCommunitiesResponse): LemmyapiDatatypesListCommunitiesResponse = LemmyapiDatatypesListCommunitiesResponse(
    ...
    override fun toUni(d: X3DatatypesModBanFromCommunityView): LemmyapiDatatypesModBanFromCommunityView = LemmyapiDatatypesModBanFromCommunityView(
    ...
    override fun toUni(d: X3DatatypesModHideCommunity): LemmyapiDatatypesModChangeCommunityVisibility =
    ...
    override fun toUni(d: X3DatatypesModHideCommunityView): LemmyapiDatatypesModChangeCommunityVisibilityView =
    ...
    override fun toUni(d: X3DatatypesModRemoveCommentView): LemmyapiDatatypesModRemoveCommentView =
        LemmyapiDatatypesModRemoveCommentView(
            ...
            moderator = d.moderator?.let { this.toUni(d = it) },
            comment = this.toUni(d = d.comment, X3DatatypesCommentAggregates(-1, -1, -1, -1, "", -1)),
    ...
    override fun toUni(d: X3DatatypesModTransferCommunityView): LemmyapiDatatypesModTransferCommunityView = LemmyapiDatatypesModTransferCommunityView(
    ...
    override fun toUni(d: X3DatatypesMyUserInfo): LemmyapiDatatypesMyUserInfo =
        LemmyapiDatatypesMyUserInfo(
            ...
            moderates = d.moderates.map { this.toUni(d = it) },
            community_blocks = d.community_blocks.map { this.toUni(d = it.community, counts = X3DatatypesCommunityAggregates(-1, -1, -1, -1, "", -1, -1, -1, -1)) },
    ...
    fun toUni(d: X3DatatypesPerson) = this.toUni(d, X3DatatypesPersonAggregates(-1, -1, -1))

    override fun toUni(d: X3DatatypesPerson, counts: X3DatatypesPersonAggregates): LemmyapiDatatypesPerson = LemmyapiDatatypesPerson(
        id = d.id,
        name = d.name,
    ...
    override fun toUni(d: X3DatatypesPrivateMessageReportResponse): LemmyapiDatatypesPrivateMessageReportResponse = LemmyapiDatatypesPrivateMessageReportResponse(
        private_message_report_view = this.toUni(d = d.private_message_report_view),
    )

    override fun toUni(d: X3DatatypesPrivateMessageReportView): LemmyapiDatatypesPrivateMessageReportView = LemmyapiDatatypesPrivateMessageReportView(
    ...
    override fun toUni(d: X3DatatypesReadableFederationState): LemmyapiDatatypesReadableFederationState = LemmyapiDatatypesReadableFederationState(
        instance_id = d.instance_id,
    ...
    override fun toUni(d: X3DatatypesRegistrationApplication): LemmyapiDatatypesRegistrationApplication = LemmyapiDatatypesRegistrationApplication(
        id = d.id,
    ...
    override fun toUni(d: X3DatatypesRegistrationApplicationView): LemmyapiDatatypesRegistrationApplicationView = LemmyapiDatatypesRegistrationApplicationView(
        registration_application = this.toUni(d = d.registration_application),
    ...
    override fun fromUni(d: LemmyapiDatatypesApproveRegistrationApplication): X3DatatypesApproveRegistrationApplication = X3DatatypesApproveRegistrationApplication(
        id = d.id,
        approve = d.approve,
        deny_reason = d.deny_reason,
    )
    ...
    override fun fromUni(d: LemmyapiDatatypesCreatePrivateMessageReport): X3DatatypesCreatePrivateMessageReport = X3DatatypesCreatePrivateMessageReport(
        private_message_id = d.private_message_id,
        reason = d.reason,
    )
    ...
    override fun fromUniC(d: it.vercruysse.lemmyapi.datatypes.ListReports): X3DatatypesListCommentReports =
    ...
    override fun fromUniP(d: it.vercruysse.lemmyapi.datatypes.ListReports): X3DatatypesListPostReports =
    ...
    override fun fromUniPm(d: it.vercruysse.lemmyapi.datatypes.ListReports): X3DatatypesListPrivateMessageReports =
    ...
    override fun fromUni(d: LemmyapiDatatypesListRegistrationApplications): X3DatatypesListRegistrationApplications = X3DatatypesListRegistrationApplications(
        unread_only = d.unread_only,
        page = d.page,
        limit = d.limit,
    )
    ...
    override fun fromUni(d: LemmyapiDatatypesResolvePrivateMessageReport): X3DatatypesResolvePrivateMessageReport = X3DatatypesResolvePrivateMessageReport(
        report_id = d.report_id,
        resolved = d.resolved,
    )
