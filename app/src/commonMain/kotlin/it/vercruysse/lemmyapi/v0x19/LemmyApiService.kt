...
class LemmyApiService(
    ...
    baseUrl: String,
    auth: String? = null,
) : LemmyApi(defaultClient, actualVersion, baseUrl, auth) {
    var client: HttpClient = defaultClient.addAuth(auth)

    override var auth: String?
        get() = super.auth
        set(value) {
            super.auth = value
            client = defaultClient.addAuth(value)
        }
     ...
     * @GET("site")
     */
    override suspend fun getSite(): Result<GetSiteResponse> = client.getResult("site")
     ...
     * @PUT("community/hide")
     */
    override suspend fun hideCommunity(form: HideCommunity): Result<Unit> = client.putResult("community/hide", form)
     ...
     */
    override suspend fun getFederatedInstances(): Result<GetFederatedInstancesResponse> = client.getResult("federated_instances")
     ...
     */
    override suspend fun markPostAsRead(form: MarkPostAsRead): Result<Unit> = client.postResult("post/mark_as_read", form)
     ...
     */
    override suspend fun getCaptcha(): Result<GetCaptchaResponse> = client.getResult("user/get_captcha")
     ...
     * @GET("user/banned")
     */
    override suspend fun getBannedPersons(): Result<BannedPersonsResponse> = client.getResult("user/banned")
     ...
     */
    override suspend fun markAllAsRead(): Result<GetRepliesResponse> = client.postResult("user/mark_all_as_read")
     ...
     */
    override suspend fun saveUserSettings(form: SaveUserSettings): Result<Unit> = client.putResult("user/save_user_settings", form)
     ...
     */
    override suspend fun changePassword(form: ChangePassword): Result<Unit> = client.putResult("user/change_password", form)
     ...
     */
    override suspend fun getUnreadCount(): Result<GetUnreadCountResponse> = client.getResult("user/unread_count")
     ...
     */
    override suspend fun leaveAdmin(): Result<GetSiteResponse> = client.postResult("user/leave_admin")
     ...
     * @POST("site/block")
     */
    override suspend fun blockInstance(form: BlockInstance): Result<BlockInstanceResponse> = client.postResult("site/block", form)
     ...
     */
    override suspend fun generateTotpSecret(): Result<GenerateTotpSecretResponse> = client.postResult("user/totp/generate")
     ...
     */
    override suspend fun updateTotp(form: UpdateTotp): Result<UpdateTotpResponse> = client.postResult("user/totp/update", form)
     ...
     */
    override suspend fun getUserExportSettings(): Result<GetUserExportSettingsResponse> = client.getResult("user/export_settings")
     ...
     */
    override suspend fun getUserImportSettings(form: GetUserImportSettings): Result<Unit> = client.postResult("user/import_settings", form)
     ...
     */
    override suspend fun listLogins(): Result<LoginToken> = client.getResult("user/list_logins")
     ...
     */
    override suspend fun validateAuth(): Result<Unit> = client.getResult("user/validate_auth")
     ...
     * @POST("user/logout")
     */
    override suspend fun logout(): Result<Unit> = client.postResult("user/logout")
