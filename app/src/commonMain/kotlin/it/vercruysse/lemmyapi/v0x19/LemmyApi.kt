...
abstract class LemmyApi(
     ...
     */
    abstract suspend fun changePassword(form: ChangePassword): Result<Unit>
     ...
     */
    abstract suspend fun getUserExportSettings(): Result<GetUserExportSettingsResponse>
     ...
     */
    abstract suspend fun getUserImportSettings(form: GetUserImportSettings): Result<Unit>
     ...
     */
    abstract suspend fun listLogins(): Result<LoginToken>
