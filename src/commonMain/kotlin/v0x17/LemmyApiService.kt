...
suspend fun main() {
    ...
    // Caused by: kotlinx.serialization.SerializationException: dto.RegistrationMode does not contain element with name 'requireapplication' at path $.site_view.local_site.registration_mode
}
