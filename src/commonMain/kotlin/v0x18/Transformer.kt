...
import v0x18.datatypes.DeleteCustomEmojiResponse as V0x18DatatypesDeleteCustomEmojiResponse
...
import v0x18.datatypes.MarkPostAsRead as V0x18DatatypesMarkPostAsRead
...
import v0x18.datatypes.PurgeItemResponse as V0x18DatatypesPurgeItemResponse
...
import v0x19.datatypes.DeleteCustomEmojiResponse as V0x19DatatypesDeleteCustomEmojiResponse
...
import v0x19.datatypes.MarkPostAsRead as V0x19DatatypesMarkPostAsRead
...
import v0x19.datatypes.PurgeItemResponse as V0x19DatatypesPurgeItemResponse
...
class Transformer(var auth: String) : DatatypesMapper {
    ...
    private fun mapLocalUserView(l: LocalUserView): V0x19DatatypesLocalUserView = V0x19DatatypesLocalUserView(
        local_user = V0x19DatatypesLocalUser(
            ...
            validator_time = l.local_user.validator_time,
    ...
    override fun toV0x19(d: V0x18DatatypesLocalUser): V0x19DatatypesLocalUser =
        v0x19.datatypes.LocalUser(
            ...
            validator_time = d.validator_time,
    ...
    override fun toV0x19(d: V0x18DatatypesPostAggregates): V0x19DatatypesPostAggregates =
        v0x19.datatypes.PostAggregates(
            ...
            newest_comment_time_necro = d.newest_comment_time_necro,
            newest_comment_time = d.newest_comment_time,
            featured_community = d.featured_community,
            featured_local = d.featured_local,
            hot_rank = d.hot_rank.toFloat(),
            hot_rank_active = d.hot_rank_active.toFloat(),
            community_id = -1,
            creator_id = -1,
            controversy_rank = 0,
            instance_id = -1,
    ...
    override fun toV0x19(d: V0x18DatatypesDeleteCustomEmojiResponse): V0x19DatatypesDeleteCustomEmojiResponse = v0x19.datatypes.DeleteCustomEmojiResponse(
        id = d.id,
        success = d.success,
    )
    ...
    override fun toV0x19(d: V0x18DatatypesPurgeItemResponse): V0x19DatatypesPurgeItemResponse =
        v0x19.datatypes.PurgeItemResponse(
            success = d.success,
        )
    ...
    override fun toV0x18(d: V0x19DatatypesMarkPostAsRead): V0x18DatatypesMarkPostAsRead =
        v0x18.datatypes.MarkPostAsRead(
            post_id = d.post_id,
            read = d.read,
            auth = auth,
        )
