...
class Transformer(var auth: String) : DatatypesMapper {
    ...
    override fun toV0x19(d: V0x18DatatypesAddModToCommunityResponse):
        V0x19DatatypesAddModToCommunityResponse = v0x19.datatypes.AddModToCommunityResponse(
    ...
    override fun toV0x19(d: V0x18DatatypesAdminPurgeCommunityView):
        V0x19DatatypesAdminPurgeCommunityView = v0x19.datatypes.AdminPurgeCommunityView(
    ...
    override fun toV0x19(d: V0x18DatatypesBanFromCommunityResponse):
        V0x19DatatypesBanFromCommunityResponse = v0x19.datatypes.BanFromCommunityResponse(
    ...
    override fun toV0x19(d: V0x18DatatypesBlockCommunityResponse):
        V0x19DatatypesBlockCommunityResponse = v0x19.datatypes.BlockCommunityResponse(
    ...
    override fun toV0x19(d: V0x18DatatypesCommunityModeratorView):
        V0x19DatatypesCommunityModeratorView = v0x19.datatypes.CommunityModeratorView(
        community = this.toV0x19(d = d.community),
    ...
    override fun toV0x19(d: V0x18DatatypesGetFederatedInstancesResponse):
        V0x19DatatypesGetFederatedInstancesResponse = v0x19.datatypes.GetFederatedInstancesResponse(
    ...
    override fun toV0x19(d: V0x18DatatypesGetPersonDetailsResponse):
        V0x19DatatypesGetPersonDetailsResponse = v0x19.datatypes.GetPersonDetailsResponse(
        person_view = this.toV0x19(d = d.person_view),
        comments = d.comments.map { this.toV0x19(d = it) },
    ...
    override fun toV0x19(d: V0x18DatatypesGetPersonMentionsResponse):
        V0x19DatatypesGetPersonMentionsResponse = v0x19.datatypes.GetPersonMentionsResponse(
    ...
    override fun toV0x19(d: V0x18DatatypesGetReportCountResponse):
        V0x19DatatypesGetReportCountResponse = v0x19.datatypes.GetReportCountResponse(
        community_id = d.community_id,
    ...
    override fun toV0x19(d: V0x18DatatypesGetSiteMetadataResponse):
        V0x19DatatypesGetSiteMetadataResponse = v0x19.datatypes.GetSiteMetadataResponse(
    ...
    override fun toV0x19(d: V0x18DatatypesGetUnreadCountResponse):
        V0x19DatatypesGetUnreadCountResponse = v0x19.datatypes.GetUnreadCountResponse(
        replies = d.replies,
        mentions = d.mentions,
        private_messages = d.private_messages
    )

    override fun toV0x19(d: V0x18DatatypesGetUnreadRegistrationApplicationCountResponse):
    ...
    override fun toV0x19(d: V0x18DatatypesListCommentReportsResponse):
        V0x19DatatypesListCommentReportsResponse = v0x19.datatypes.ListCommentReportsResponse(
        comment_reports = d.comment_reports.map { this.toV0x19(d = it) }
    )

    override fun toV0x19(d: V0x18DatatypesListCommunitiesResponse):
        V0x19DatatypesListCommunitiesResponse = v0x19.datatypes.ListCommunitiesResponse(
        communities = d.communities.map { this.toV0x19(d = it) }
    )

    override fun toV0x19(d: V0x18DatatypesListPostReportsResponse):
        V0x19DatatypesListPostReportsResponse = v0x19.datatypes.ListPostReportsResponse(
        post_reports = d.post_reports.map { this.toV0x19(d = it) }
    )

    override fun toV0x19(d: V0x18DatatypesListPrivateMessageReportsResponse):
        V0x19DatatypesListPrivateMessageReportsResponse =
        v0x19.datatypes.ListPrivateMessageReportsResponse(
            private_message_reports = d.private_message_reports.map { this.toV0x19(d = it) }
        )

    override fun toV0x19(d: V0x18DatatypesListRegistrationApplicationsResponse):
        V0x19DatatypesListRegistrationApplicationsResponse =
    ...
    override fun toV0x19(d: V0x18DatatypesModBanFromCommunityView):
        V0x19DatatypesModBanFromCommunityView = v0x19.datatypes.ModBanFromCommunityView(
    ...
    override fun toV0x19(d: V0x18DatatypesModRemoveCommunityView):
        V0x19DatatypesModRemoveCommunityView = v0x19.datatypes.ModRemoveCommunityView(
    ...
    override fun toV0x19(d: V0x18DatatypesModTransferCommunityView):
        V0x19DatatypesModTransferCommunityView = v0x19.datatypes.ModTransferCommunityView(
    ...
    override fun toV0x19(d: V0x18DatatypesPrivateMessageReportResponse):
        V0x19DatatypesPrivateMessageReportResponse = v0x19.datatypes.PrivateMessageReportResponse(
        private_message_report_view = this.toV0x19(d = d.private_message_report_view)
    )

    override fun toV0x19(d: V0x18DatatypesPrivateMessageReportView):
        V0x19DatatypesPrivateMessageReportView = v0x19.datatypes.PrivateMessageReportView(
    ...
    override fun toV0x19(d: V0x18DatatypesPrivateMessageResponse):
        V0x19DatatypesPrivateMessageResponse = v0x19.datatypes.PrivateMessageResponse(
        private_message_view = this.toV0x19(d = d.private_message_view)
    )

    override fun toV0x19(d: V0x18DatatypesPrivateMessagesResponse):
        V0x19DatatypesPrivateMessagesResponse = v0x19.datatypes.PrivateMessagesResponse(
    ...
    override fun toV0x19(d: V0x18DatatypesRegistrationApplication):
        V0x19DatatypesRegistrationApplication = v0x19.datatypes.RegistrationApplication(
        id = d.id,
    ...
    override fun toV0x19(d: V0x18DatatypesRegistrationApplicationResponse):
        V0x19DatatypesRegistrationApplicationResponse =
        v0x19.datatypes.RegistrationApplicationResponse(
            registration_application = this.toV0x19(d = d.registration_application)
        )

    override fun toV0x19(d: V0x18DatatypesRegistrationApplicationView):
        V0x19DatatypesRegistrationApplicationView = v0x19.datatypes.RegistrationApplicationView(
        registration_application = this.toV0x19(d = d.registration_application),
    ...
    override fun toV0x18(d: V0x19DatatypesApproveRegistrationApplication):
        V0x18DatatypesApproveRegistrationApplication = v0x18.datatypes.ApproveRegistrationApplication(
        id = d.id,
        approve = d.approve,
        deny_reason = d.deny_reason,
        auth = auth
    ...
    override fun toV0x18(d: V0x19DatatypesCreatePrivateMessageReport):
        V0x18DatatypesCreatePrivateMessageReport = v0x18.datatypes.CreatePrivateMessageReport(
        private_message_id = d.private_message_id,
        reason = d.reason,
        auth = auth
    )
    ...
    override fun toV0x18(d: V0x19DatatypesListPrivateMessageReports):
        V0x18DatatypesListPrivateMessageReports = v0x18.datatypes.ListPrivateMessageReports(
        page = d.page,
        limit = d.limit,
        unresolved_only = d.unresolved_only,
        auth = auth
    ...
    override fun toV0x18(d: V0x19DatatypesListRegistrationApplications):
        V0x18DatatypesListRegistrationApplications = v0x18.datatypes.ListRegistrationApplications(
        unread_only = d.unread_only,
        page = d.page,
        limit = d.limit,
        auth = auth
    ...
    override fun toV0x18(d: V0x19DatatypesMarkCommentReplyAsRead):
        V0x18DatatypesMarkCommentReplyAsRead = v0x18.datatypes.MarkCommentReplyAsRead(
        comment_reply_id = d.comment_reply_id,
        read = d.read,
        auth = auth
    )

    override fun toV0x18(d: V0x19DatatypesMarkPersonMentionAsRead):
        V0x18DatatypesMarkPersonMentionAsRead = v0x18.datatypes.MarkPersonMentionAsRead(
        person_mention_id = d.person_mention_id,
        read = d.read,
        auth = auth
    )

    override fun toV0x18(d: V0x19DatatypesMarkPrivateMessageAsRead):
        V0x18DatatypesMarkPrivateMessageAsRead = v0x18.datatypes.MarkPrivateMessageAsRead(
        private_message_id = d.private_message_id,
        read = d.read,
        auth = auth
    )

    override fun toV0x18(d: V0x19DatatypesPasswordChangeAfterReset):
        V0x18DatatypesPasswordChangeAfterReset = v0x18.datatypes.PasswordChangeAfterReset(
        token = d.token,
        password = d.password,
    ...
    override fun toV0x18(d: V0x19DatatypesResolvePrivateMessageReport):
        V0x18DatatypesResolvePrivateMessageReport = v0x18.datatypes.ResolvePrivateMessageReport(
        report_id = d.report_id,
        resolved = d.resolved,
        auth = auth
    )
